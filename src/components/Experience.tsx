...
const Experience = () => {
  ...
  return (
    <section id="experience" className="section-padding bg-background border-b border-gray-100">
          ...
          {experienceData.map((exp, index) => (
            ...
            >
              ...
              {index < experienceData.length - 1 && (
                <div className="absolute left-[5px] top-4 bottom-0 w-[1.5px] bg-gray-200" />
              )}

              {/* Timeline dot */}
              <div className="absolute left-0 top-[6px] w-[11px] h-[11px] rounded-full bg-white border-2 border-primary" />

              <div className="mb-1.5">
                <h3 className="font-dm-sans font-semibold text-base text-foreground">
                  {exp.role}
                </h3>
              ...
              <ul className="mt-3 space-y-1.5">
                {exp.highlights.map((h, i) => (
                  <li key={i} className="flex items-start gap-2 font-inter text-sm text-muted-foreground leading-relaxed">
